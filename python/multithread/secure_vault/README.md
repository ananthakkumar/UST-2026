SECURE FILE VAULT WITH AUDIT LOGS

here it si a python program that allows the sensitive files to be encrypted  and decrypted. it ensures that unauthorized access is prevented, while maintaining a detailed audit log of all actions. 
